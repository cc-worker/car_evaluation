...
var Layout = function () {
    ...
    return {
        ...
        loadAjaxContent222:function(url, sidebarMenuLink){
            var pageContent = $('.page-content .page-content-body');
            $.ajax({
                type: "POST",
                url: 'http://192.168.20.128:8000/page_content/',
                data:{"page_name":url},
                success: function (res) {
                    ...
                    console.log(res)
                    console.log("*************************************************************************")
                    pageContent.html(res.content);

                    for (var i = 0; i < ajaxContentSuccessCallbacks.length; i++) {
                        ajaxContentSuccessCallbacks[i].call(res.content);
                    }
